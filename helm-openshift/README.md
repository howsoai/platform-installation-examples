...
Ensure you have completed the [prerequisites](../prereqs/README.md) before proceeding, have a OpenShift cluster running, with a howso project (namespace), and are logged into the Helm registry.
